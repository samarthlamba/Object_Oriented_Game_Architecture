...
/**
 * This class is used to build a specific implementation of a Game object from a single string in a file.
 * It is intended to be use primarily by the GameFactory.
...
public class GameObjectFactory<T> {
  ...
  public T makeGameObject(String symbolToConvert, double x, double y) throws FactoryException {
    try{
      ...
      throw new FactoryException(String.format("Symbol %s not present in this game",symbolToConvert),e);
    }
  }
