...
/**
 * This class builds GameBeans for a specific game and file location
 *  GameBeans are used to feed constants in property files into a Game
 */
public class GameBeanFactory {
   ...
   * @param fileLocation The file location of this bean, which should correspond to the name of the level
   * it will be used for
   * @param <T> The implementation of game bean corresponding to class, i.e. MarioBean, VikingsBean, etc.
