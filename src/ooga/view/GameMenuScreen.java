...
public class GameMenuScreen extends Screen {
  ...
  ;
  String language = "eng";
  ResourceBundle gameMenuButtonProperties = ResourceBundle
      .getBundle(DEFAULT_RESOURCE_PACKAGE + "gamemenubuttons_" + language);
  ...
  public GameMenuScreen(String gameTitle, Consumer launchGame, Consumer randomLevel) {
    ...
    Image titleImage = new Image(String.format(TITLE_PATH, gameTitle), IMAGE_WIDTH, IMAGE_HEIGHT,
        true, true);
