...
public class Display {//implements Viewer{
  ...
  private static final ResourceBundle GAME_LABELS = ResourceBundle
      .getBundle(DEFAULT_RESOURCE_PACKAGE + "mainmenubuttons_eng");
...
//        gameScreen = new GamePlayScreen(pause, play, restart);
  ...
  public void setSplashScreen(GameEndStatus displayKey) {
    SplashScreen resultScreen = new SplashScreen(displayKey, this::setMainMenuScreen,
        this::restartGame);
